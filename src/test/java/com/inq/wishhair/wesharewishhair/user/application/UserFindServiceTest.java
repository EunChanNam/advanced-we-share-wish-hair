...
class UserFindServiceTest {
	...
	public UserFindServiceTest() {
		this.userRepository = Mockito.mock(UserRepository.class);
		this.userFindService = new UserFindService(userRepository);
	}
	...
	class getById {
		...
		void success() {
			...
			//when
			User actual = userFindService.getById(userId);
		...
		void fail() {
			...
			//when
			ThrowingCallable when = () -> userFindService.getById(userId);
	...
	class getByEmail {
		...
		void success() {
			...
			//when
			User actual = userFindService.getByEmail(email);
		...
		void fail() {
			...
			//when
			ThrowingCallable when = () -> userFindService.getByEmail(email);
